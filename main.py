...
print("Those are the board cells:")
print("|   1   |   2   |   3   |")
print("|   4   |   5   |   6   |")
print("|   7   |   8   |   9   |")
...
def game(game_board, coords, player):
    # Player input check(1-9 number), board changes
    field = ""
    while True:
        field = input(f"Player {player[0]} choose a cell position: 1-9\n")
        if field == "":
...
def check_for_win(game_board, player):
    # Player win check
    first_row, second_row, third_row = False, False, False
    first_col, second_col, third_col = False, False, False
    first_diag, second_diag = False, False
